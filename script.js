...
new TypeIt("#teks1", {
  strings: ["You are only one whome I feel comfortable when I talked after my hectic day♡💓", "Your company is awesome whether is about gaming Truth and Dare or teasing each other(btw jitta to me hi tha😂)","Tumhara Abal Babal bhi ek mystery hai to agle bday tk vo bhi resolve krna🤔" , "Tumhare sath baat kraya hua har ek pal memorable hai mere liye🤗","Your face, Your eyes ki to sb tarif krenge but your voice on the top notch vo voice note me song bhi bahut hi pyara hai😊😊"],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["Whether it is vo shaadi wala tym jb hum proper last day me hi baat kri thi", " ", "but tbhi hi ek acha connection bn gya tha in my pov😁 jo ki mere liye bahut hi acha hai", " ", "At last A Very Happiest Birtdhay.. Kangaroo(Kanishka)"," ","And I want to say that...."],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
